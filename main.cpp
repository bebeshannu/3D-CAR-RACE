...
int winner(char a)
{
    ...
    PlaySound("D:\\Project\\CG\\carr\\lost.wav", NULL,SND_ASYNC | SND_FILENAME );
    numberOfQuotes = 5;
...
void keyboard(unsigned char key, int x, int y)
{
    ...
    {
        PlaySound("D:\\Project\\CG\\carr\\\\horn1.wav", NULL, SND_ASYNC | SND_FILENAME);
        // PlaySound("D:\\Project\\CG\\carr\\retro.wav", NULL, SND_ASYNC |SND_FILENAME|SND_LOOP );
    }
    else if(key=='s')
    {
        //PlaySound("D:\\Project\\CG\\carr\\\\horn2.wav", NULL, SND_FILENAME );
         PlaySound("D:\\Project\\CG\\carr\\retro.wav", NULL, SND_ASYNC |SND_FILENAME|SND_LOOP );
    }
    else if(key=='e')
    {
...
int main(int argc, char** argv)
{
    ...
    PlaySound("D:\\Project\\CG\\carr\\opener.wav", NULL, SND_FILENAME );
    glutInit(&argc, argv);
    glutInitDisplayMode(GLUT_DOUBLE | GLUT_RGB | GLUT_DEPTH);
    glutInitWindowSize(800, 500);
